...
>
	...
	>
		...
		<button
			type="button"
			disabled
			class="mt-3 flex w-full cursor-not-allowed items-center justify-center gap-2 rounded-lg border border-app-border bg-app-element/40 px-3 py-2.5 text-sm text-app-text opacity-70"
		>
			...
			<span class="text-[10px] font-bold uppercase tracking-[0.2em] text-app-subtext">soon</span>
		</button>
